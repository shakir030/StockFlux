...
public class activity_expense_sales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sales_expense_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query query = fSalesExpenses.collection("salesExpenses").whereEqualTo("date", expense_sales_date).whereEqualTo("name", expense_sales_name);
    ...
    public void AddExpenseData(String expense_sales_name) {
        ...
        fSalesExpenses.collection("salesExpenses").document().set(add_sales_expense).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
